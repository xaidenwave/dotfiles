...
static const char *fonts[]          = { "monospace:size=10", "Font Awesome 5 Free Solid:size=10", "Font Awesome 5 Brands Regular:size=10", "JoyPixels:pixelsize=12:antialias=true:autohint=true" };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_F10,    spawn,          SHCMD("pkill mpv") },
